...
var groupHero = document.querySelector('.Group-hero');
var logo = document.querySelector('.logo');


let user = exports.find(item => item.parent == 4);
console.log(user.name);

let someexports = exports.filter(item => item.id < 3);
console.log(someexports.length);


groupHero.onclick = function (){
	document.getElementById("myImage").src="img/Nilfgaard.jpg";
	console.log( exports[3].parent );
